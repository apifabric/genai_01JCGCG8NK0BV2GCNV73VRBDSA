...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.PackingList, method_decorators= method_decorators)
    api.expose_object(database.models.Review, method_decorators= method_decorators)
    api.expose_object(database.models.Transport, method_decorators= method_decorators)
    api.expose_object(database.models.TravelCompanion, method_decorators= method_decorators)
    api.expose_object(database.models.TravelInsurance, method_decorators= method_decorators)
    api.expose_object(database.models.Wishlist, method_decorators= method_decorators)
    return api
