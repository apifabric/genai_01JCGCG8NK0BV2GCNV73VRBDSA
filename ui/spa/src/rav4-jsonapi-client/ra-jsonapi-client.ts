  ...
  return {
    ...
    ********************************************************************************************/
    ...
    getResources: () => {
      ...
      execute: (resource_name_en: string, payload: {  id: string|null, data: any, command:string }) => {
        const conf = getConf();
        const resource_name = decodeURI(resource_name_en)
        console.log(`execute rpc on resource {resource_name} with params`, payload)
        const id = payload.id || ""
        ...
        const endpoint = payload.id ? `${apiUrl}/${resource_name}/${id}/${command}` : `${apiUrl}/${resource_name}/${command}`
