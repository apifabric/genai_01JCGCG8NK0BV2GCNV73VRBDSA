...
resourcename="holidayplanner"  # lower case, only
resourcegroup="holidayplanner_rg"
...
# git clone https://github.com/apilogicserver/holidayplanner.git
# cd holidayplanner
...
az group create --name holidayplanner_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group holidayplanner_rg --sku S1 --is-linux
az container create --resource-group holidayplanner_rg --name holidayplanner --image apilogicserver/holidayplanner:latest --dns-name-label holidayplanner --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//holidayplanner.westus.azurecontainer.io:5656'
